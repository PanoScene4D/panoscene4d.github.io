...
class Shortcuts {
    ...
    constructor(events: Events) {
        ...
        const handleEvent = (e: KeyboardEvent, down: boolean, capture: boolean) => {
            // Ignore typing contexts, but do not require body focus. During XR/emulator
            // sessions keyboard events often target the canvas or a focused wrapper rather
            // than document.body, and locomotion should still work there.
